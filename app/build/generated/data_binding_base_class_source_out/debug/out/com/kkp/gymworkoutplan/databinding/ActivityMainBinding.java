...
public final class ActivityMainBinding implements ViewBinding {
  ...
  @NonNull
  public final Switch swMemberVsBuddy;
  ...
  private ActivityMainBinding(@NonNull ConstraintLayout rootView,
      ...
      @NonNull Switch swMemberVsBuddy, @NonNull TextView tvAccName) {
    this.rootView = rootView;
    this.bottomNavigationView = bottomNavigationView;
    this.flFragment = flFragment;
    this.swMemberVsBuddy = swMemberVsBuddy;
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.swMemberVsBuddy;
      Switch swMemberVsBuddy = ViewBindings.findChildViewById(rootView, id);
      if (swMemberVsBuddy == null) {
        break missingId;
      }
